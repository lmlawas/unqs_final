...
\textbf{DESTINATION (\# of flows)} 		& \textbf{TOTAL BYTES} 	& \textbf{\%} \\ \hline
	...
	% MULTICAST							&  1575146908           & 1.5         \\ \hline
	% MULTICAST							&  1562493373           & 1.5         \\ \hline
	% Google LLC							&  1242563600           & 1.2         \\ \hline
	Apple Inc.(1)						&  1054547100           & 1.0         \\ \hline
	% Google LLC							&  1039431952           & 1.0         \\ \hline
\end{tabular}
\end{table*}
...
\textbf{SOURCE (\# of flows)} 		& \textbf{TOTAL BYTES} 	& \textbf{\%} \\ \hline
    ...
    % Google LLC						&  2815063488           & 1.5         \\ \hline
    M247 Ltd(2)						&  4286472241           & 2.3         \\ \hline
    Converge ICT Solutions Inc.(2)	&  3967550023			& 2.2         \\ \hline
    % M247 Ltd						&  2098695101           & 1.1         \\ \hline
    % Converge ICT Solutions Inc.		&  1812641471           & 1.0         \\ \hline
    % Google LLC						&  1750693948           & 1.0         \\ \hline
\end{tabular}
\end{table*}
